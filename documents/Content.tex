...
In this set of experiments, we justify our initial hypothesis: the mutual
...
\begin{figure*}[t!]V
\centering
\includegraphics[width=2\columnwidth]{plots/column-select-score-algo}
...
\begin{figure*}[t!]V
\centering
\includegraphics[width=2\columnwidth]{plots/column-select-score-beam}
