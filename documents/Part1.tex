...
Given a hypercube $T$, Claude's aim is to generate a ranked set of suggestions.
...
In the previous section, we defined our search space: we want to suggest views
